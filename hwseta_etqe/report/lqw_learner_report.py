...
class lqw_learner_achievement_certificate(report_sxw.rml_parse):

	def __init__(self, cr, uid, name, context=None):
		super(lqw_learner_achievement_certificate, self).__init__(
...
class leave_report_view(osv.AbstractModel):
	...
	_template = 'hwseta_etqe.lqw_report_achievement_certificate'
	_wrapped_report_class = lqw_learner_achievement_certificate
